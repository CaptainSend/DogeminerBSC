var minersAddr = '0x09cecA698658436E440290FEb02EeC4Daac9459e';
var tokenAddr = '0xbA2aE424d960c26247Dd6c32edC70B295c744C43';
var minersAbi =
[
	{
		"constant": true,
...
function buyEggs(ref, trx, callback){
	if(+trx > +usrBal) {
		alert("You don't have " + trx + " DOGE in your wallet");
	}
	else if(+trx > +spend) {
		alert("Approve spending " + trx + " DOGE first");
	} else {
